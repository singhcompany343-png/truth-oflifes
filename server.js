...
const CHAPTER_MAP = {"Anatomy":["General Anatomy","Osteology","Arthrology (Joints)","Myology (Muscles)","Cardiovascular System","Respiratory System","Digestive System","Urinary System","Reproductive System","Endocrine System","Nervous System","Head & Neck","Thorax","Abdomen","Pelvis & Perineum","Upper Limb","Lower Limb","Neuroanatomy","Cranial Nerves","Autonomic Nervous System","Histology","Embryology","Genetics","Radiological Anatomy"],"Physiology":["General Physiology","Blood","Nerve & Muscle Physiology","Cardiovascular System","Respiratory System","Gastrointestinal System","Renal Physiology","Endocrinology","Reproductive Physiology","Central Nervous System","Special Senses","Temperature Regulation","Exercise Physiology","Environmental Physiology","Acid-Base Balance"],"Biochemistry":["Biomolecules","Carbohydrates","Lipids","Proteins","Amino Acids","Enzymes","Vitamins","Minerals","Nucleic Acids","DNA & RNA","Molecular Biology","Carbohydrate Metabolism","Lipid Metabolism","Protein Metabolism","Heme Metabolism","Purine & Pyrimidine Metabolism","Biological Oxidation","Nutrition","Clinical Biochemistry","Acid-Base Balance","Liver Function Tests","Renal Function Tests"],"Pharmacology":["General Pharmacology","Pharmacokinetics","Pharmacodynamics","Autonomic Nervous System","Cholinergic Drugs","Adrenergic Drugs","Cardiovascular Drugs","Diuretics","Blood & Blood-forming Drugs","CNS Pharmacology","Antiepileptic Drugs","Antipsychotic Drugs","Antidepressants","Analgesics","Anti-inflammatory Drugs","Respiratory Drugs","GI Drugs","Endocrine Pharmacology","Antimicrobial Drugs","Antitubercular Drugs","Antileprotic Drugs","Antimalarial Drugs","Anticancer Drugs","Immunopharmacology","Toxicology"],"Pathology":["Introduction to Pathology","Cell Injury","Cell Death","Inflammation","Healing & Repair","Hemodynamic Disorders","Edema","Thrombosis","Embolism","Shock","Genetic Disorders","Immune Disorders","Neoplasia","Blood Disorders","RBC Disorders","WBC Disorders","Platelet Disorders","Leukemia","Lymphoma","Cardiovascular Pathology","Respiratory Pathology","GI Pathology","Liver Pathology","Renal Pathology","Endocrine Pathology","CNS Pathology","Female Genital Tract Pathology","Breast Pathology"],"Microbiology":["General Microbiology","Immunology","Bacteriology","Virology","Mycology","Parasitology","Sterilization & Disinfection","Biomedical Waste","Staphylococcus","Streptococcus","Mycobacteria","Enterobacteriaceae","Vibrio","Salmonella","Shigella","E. coli","TB","Diphtheria","Tetanus","Meningitis","Hepatitis Viruses","HIV/AIDS","Influenza","Rabies","Malaria","Amoebiasis","Giardiasis","Fungal Infections"],"Forensic Medicine":["Introduction to Forensic Medicine","Medical Jurisprudence","Identification","Death & its Changes","Postmortem Examination","Mechanical Injuries","Blunt Force Injury","Sharp Force Injury","Firearm Injuries","Burns","Asphyxial Deaths","Hanging","Strangulation","Drowning","Sexual Offences","Infanticide","Medicolegal Autopsy","Toxicology","Poisoning","Alcohol Poisoning","Snake Bite","Organophosphorus Poisoning","Medical Ethics","Consent","Medical Negligence"],"Community Medicine":["Concept of Health & Disease","Epidemiology","Screening","Biostatistics","Demography","Health Education","Nutrition","Communicable Diseases","Tuberculosis","Malaria","HIV/AIDS","Leprosy","Non-Communicable Diseases","Diabetes","Hypertension","Cancer","Maternal & Child Health","Family Planning","Immunization","National Health Programs","Environmental Health","Occupational Health","School Health","Geriatric Health","Disaster Management"],"Medicine":["Clinical Methods","Cardiovascular Diseases","Respiratory Diseases","Gastrointestinal Diseases","Liver Diseases","Renal Diseases","Neurology","Endocrinology","Diabetes Mellitus","Thyroid Disorders","Rheumatology","Hematology","Infectious Diseases","Fever","HIV/AIDS","Electrolyte Disorders","Acid-Base Disorders","Emergency Medicine","Poisoning","Geriatric Medicine"],"Surgery":["General Principles of Surgery","Wound Healing","Surgical Infections","Shock","Fluid & Electrolyte Management","Burns","Trauma","Head Injury","Neck Swellings","Breast Diseases","Thyroid","Esophagus","Stomach","Small Intestine","Large Intestine","Appendix","Rectum & Anal Canal","Liver","Gallbladder","Pancreas","Hernia","Vascular Surgery","Urology","Neurosurgery","Pediatric Surgery","Plastic Surgery"],"Pediatrics":["Growth & Development","Neonatology","Newborn Resuscitation","Nutrition","Breastfeeding","Immunization","Pediatric Infections","Respiratory Diseases","GI Diseases","CNS Diseases","Pediatric Cardiology","Congenital Heart Disease","Renal Diseases","Endocrine Disorders","Pediatric Hematology","Pediatric Emergencies","Genetic Disorders","Adolescent Health"],"OBG":["Obstetrics","Normal Pregnancy","Antenatal Care","Normal Labour","Abnormal Labour","Puerperium","High-Risk Pregnancy","Hypertensive Disorders","Gestational Diabetes","Antepartum Hemorrhage","Postpartum Hemorrhage","Ectopic Pregnancy","Abortion","Multiple Pregnancy","Rh Isoimmunization","Fetal Distress","Operative Obstetrics","Cesarean Section","Gynaecology","Menstrual Disorders","Infertility","PCOS","Endometriosis","Uterine Fibroids","Pelvic Inflammatory Disease","Cervical Cancer","Endometrial Cancer","Ovarian Tumors","Breast Diseases","Menopause","Contraception"],"Orthopedics":["General Orthopedics","Fractures","Dislocations","Bone Healing","Soft Tissue Injuries","Upper Limb Injuries","Lower Limb Injuries","Spine","Arthritis","Osteoarthritis","Rheumatoid Arthritis","Osteomyelitis","Bone Tumors","Congenital Disorders","Pediatric Orthopedics","Joint Replacement","Sports Injuries","Amputation","Orthopedic Emergencies"],"ENT":["Ear Anatomy","Hearing Physiology","External Ear","Middle Ear","Inner Ear","Otitis Media","Hearing Loss","Vertigo","Facial Nerve","Nose & Paranasal Sinuses","Rhinitis","Sinusitis","Epistaxis","Nasal Polyps","Throat","Tonsils","Adenoids","Larynx","Voice Disorders","Head & Neck Tumors","Foreign Bodies"],"Ophthalmology":["Anatomy of Eye","Physiology of Vision","Refractive Errors","Cataract","Glaucoma","Conjunctivitis","Corneal Diseases","Uveitis","Retinal Diseases","Diabetic Retinopathy","Hypertensive Retinopathy","Optic Nerve Disorders","Squint","Amblyopia","Eye Trauma","Ocular Emergencies","Orbit","Lacrimal System","Eyelid Disorders"],"Radiology":["X-Ray Basics","Chest X-Ray","Abdominal X-Ray","Skeletal X-Ray","Ultrasound","CT Scan","MRI","Contrast Media","Neuroimaging","Chest Imaging","Abdominal Imaging","Musculoskeletal Imaging","Obstetric Imaging","Breast Imaging","Interventional Radiology","Radiation Safety"],"Anesthesia":["Introduction to Anesthesia","Preoperative Assessment","General Anesthesia","Regional Anesthesia","Spinal Anesthesia","Epidural Anesthesia","Local Anesthesia","Airway Management","Endotracheal Intubation","Ventilation","Monitoring","Fluid Management","Blood Transfusion","Pain Management","CPR","Resuscitation","ICU Basics","Anesthetic Complications"],"Psychiatry":["Introduction to Psychiatry","Mental Status Examination","Anxiety Disorders","Depression","Bipolar Disorder","Schizophrenia","Psychosis","OCD","PTSD","Personality Disorders","Substance Abuse","Alcohol Dependence","Drug Dependence","Child Psychiatry","Eating Disorders","Sleep Disorders","Suicide & Self-Harm","Psychopharmacology"],"Dermatology":["Basic Dermatology","Skin Anatomy","Skin Examination","Bacterial Infections","Viral Infections","Fungal Infections","Scabies","Eczema","Psoriasis","Acne","Urticaria","Drug Reactions","Autoimmune Skin Diseases","Pigmentary Disorders","Hair Disorders","Nail Disorders","Sexually Transmitted Infections","Leprosy","Skin Tumors"],"Dentistry":["Dental Anatomy","Oral Cavity","Dental Caries","Gingivitis","Periodontitis","Oral Infections","Oral Ulcers","Oral Cancers","Dental Trauma","Tooth Extraction","Endodontics","Prosthodontics","Orthodontics","Pediatric Dentistry","Oral & Maxillofacial Surgery","Dental Materials","Oral Hygiene"],"Nursing":["Fundamentals of Nursing","Nursing Procedures","Health Assessment","Anatomy & Physiology","Nutrition","Pharmacology for Nurses","Medical-Surgical Nursing","Community Health Nursing","Child Health Nursing","Mental Health Nursing","Obstetric Nursing","Midwifery","Critical Care Nursing","Emergency Nursing","Infection Control","First Aid","Nursing Ethics","Nursing Research"],"Other":["First Aid","CPR/BLS","ECG","ABG","Medical Terminology","Clinical Examination","Differential Diagnosis","Medical Calculations","Important Drug Charts","Investigation & Lab Values","Medical Mnemonics","Case Studies","Viva Questions","Practical Notes","OSCE/OSPE","Previous Year Questions","NEET-PG/INI-CET Revision","Image-Based Questions"]};
...
async function setupDatabase() {
  ...
  // Auto-place older uploads into Subject -> Chapter when chapter/subject was not set.
  // This keeps existing resources visible in the new chapter-wise structure.
  try {
    const existing = await pool.query(`SELECT id, title, subject, chapter FROM resources`);
    ...
    for (const row of existing.rows) {
      ...
      if (!chapter || !subject) {
        let match = null;
        for (const [sub, chapters] of Object.entries(CHAPTER_MAP)) {
          for (const ch of chapters) {
            const cn = norm(ch);
            if (titleNorm === cn || (cn.length >= 5 && (titleNorm.includes(cn) || cn.includes(titleNorm)))) {
              match = { subject: sub, chapter: ch };
              break;
            }
          }
          if (match) break;
        ...
        if (match) {
          if (!subject) subject = match.subject;
          if (!chapter) chapter = match.chapter;
        }
      }

      if (subject || chapter) {
        await pool.query(
          `UPDATE resources SET subject=$1, chapter=$2 WHERE id=$3`,
          [subject || null, chapter || null, row.id]
        );
      }
    }
  } catch (e) {
    console.error("Resource chapter auto-placement failed:", e.message);
  }
